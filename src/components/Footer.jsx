  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", justifyContent: "center", gap: 3, mt: 2 }}>
        {navLinks.map((item, index) => (
          <Link
            ...
            sx={{ color: "#FFFFFF", textDecoration: "none", opacity: 0.7, "&:hover": { opacity: 1,color: "#FFFFFF" }, cursor: "pointer" }}
          >
            {item.title}
          </Link>
        ))}
      ...
      <Box sx={{ mt: 3, display: "flex", justifyContent: "center", gap: 3 }}>
        <IconButton href="mailto:contact@waynautic.com" sx={{ color: "#FFFFFF", opacity: 0.7, "&:hover": { opacity: 1, color: "white" } }}>
          <Mail />
        </IconButton>
        <IconButton href="tel:+919637611936" sx={{ color: "#FFFFFF", opacity: 0.7, "&:hover": { opacity: 1, color: "white" } }}>
          <Phone />
        </IconButton>
        <IconButton href="https://www.linkedin.com/company/waynautic-technologies" target="_blank" sx={{ color: "#FFFFFF", opacity: 0.7, "&:hover": { opacity: 1, color: "white" } }}>
          <LinkedIn />
        </IconButton>
      </Box>
